...
Scenario: new students with empty The Huxley’s name
Given that i am logged as a Admin user, "admin", with password "123456"
And that i am at the "Register students" page
When I try to upload a "XLS" file with columns "TheHuxleyName" and "LoginCin" and an entry of "" and "lbam" for those columns respectively
Then I can see a error message
